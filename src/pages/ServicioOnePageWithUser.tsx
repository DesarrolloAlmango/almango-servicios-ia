...
import zocalo from "@/assets/zocalo.svg";
...
const ServicioOnePageWithUser = () => {
  ...
  return <div className="min-h-screen bg-white">
      ...
      >
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center">
            ...
            <p className="text-white/90 text-sm">Complete el formulario para solicitar su servicio</p>
          </div>
        </div>
      </div>
      ...
      {/* Footer con zócalo */}
      <div 
        className="w-full bg-cover bg-center h-24 mt-12"
        style={{ 
          backgroundImage: `url(${zocalo})`,
          backgroundSize: 'cover',
          backgroundPosition: 'center'
        }}
      />
