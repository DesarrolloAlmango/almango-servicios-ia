  ...
  return <section className="py-16 bg-[#F0F0F0]">
      <div className="container mx-auto">
        ...
        <div 
          ...
          className="max-w-3xl mx-auto mt-8 mb-12 animate-from-left opacity-0"
        >
        ...
        <div 
          ref={servicesGridRef}
          className="animate-from-right opacity-0 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-1 gap-y-0"
        >
          {ServiceItems.map((service, index) => (
            <div key={index} className="flex flex-col items-center py-0.5 service-item opacity-0">
        ...
        <div 
          ...
          className="mt-20 flex flex-col md:flex-row items-center justify-center gap-6 animate-from-left opacity-0"
        >
          ...
          <div className="flex">
            {[0, 9, 8, 8, 0, 0].map((digit, index) => (
              <div 
                key={index} 
                className="bg-[#1A1F2C] text-white w-10 h-14 md:w-12 md:h-16 flex items-center justify-center text-xl md:text-2xl font-bold mx-0.5 service-item opacity-0"
              >
                {digit}
              </div>
            ))}
        ...
        <div 
          ref={sealsSectionRef}
          className="mt-16 animate-from-right opacity-0"
        >
