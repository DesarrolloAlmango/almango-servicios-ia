...
const Header = () => {
  ...
  return (
    <header className={cn(
      ...
      <div className="w-full bg-[#008be1] shadow-md">
        <div className="container mx-auto flex justify-between items-center px-4 py-3">
          <div className="flex items-center">
            <img 
              alt="ALMANGO Logo" 
              src="/lovable-uploads/10976e12-6bf7-48d0-b947-61ef37b1289b.png" 
              className="h-14 transition-all duration-300 object-scale-down" 
            />
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <button 
              ...
              className="uppercase text-sm text-white hover:text-gray-200 transition-colors font-semibold"
            >
              Inicio
            </button>
            <button 
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#008be1] shadow-lg absolute top-full left-0 right-0">
          <div className="flex flex-col py-4 px-6 space-y-4">
            <button 
              onClick={() => scrollToSection('inicio')} 
              className="uppercase text-sm font-medium py-2 text-white hover:text-gray-200 transition-colors text-left"
            >
              Inicio
            </button>
            <button 
