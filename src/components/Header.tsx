...
const Header = () => {
  ...
  return <header className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b font-serif', isScrolled ? 'bg-primary shadow-md py-0.5 border-black border-b-8' : 'bg-primary py-1 border-black border-b-8')}>
      <div className="container mx-auto flex justify-between items-center px-4 relative">
        <div className="flex items-center overflow-visible">
          <img alt="ALMANGO Logo" src="/lovable-uploads/10976e12-6bf7-48d0-b947-61ef37b1289b.png" className="h-20 transition-all duration-300 object-scale-down transform -translate-y-1" />
        </div>
