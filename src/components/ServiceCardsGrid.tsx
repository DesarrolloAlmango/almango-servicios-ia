  ...
  return (
    <div className="bg-[#F0F0F0] py-8 relative">
      <div className="container mx-auto px-24 sm:px-28 md:px-32 relative">
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-8 origin-center">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-8 origin-center">
