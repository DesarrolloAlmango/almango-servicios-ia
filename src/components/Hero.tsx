  ...
  return (
    <div className={`relative w-full overflow-hidden ${isMobile ? "min-h-[calc(100vh-40px)]" : "min-h-[75vh] md:min-h-[82vh]"} flex items-start pt-10 md:pt-14`}>
      ...
      <div className="container relative z-10 mx-auto px-6 text-left pl-8 md:pl-12 mt-[100px] sm:mt-[90px] md:mt-[80px]">
        ...
        <p className="text-2xl sm:text-xl text-white mb-2 max-w-xl font-normal animate-fade-in drop-shadow-lg md:text-xl py-[4px] font-serif">
          RÁPIDO. FÁCIL. SEGURO. SIN VUELTAS.
        </p>
        <Button 
          onClick={() => navigate('/servicios')} 
          className="bg-primary hover:bg-primary/80 text-white px-6 py-3 rounded-md text-xl shadow-lg flex items-center transition-all hover:scale-105 animate-fade-in my-0 mx-0 sm:py-[20px] sm:px-[21px] font-serif" 
          style={{
